...
password = {
    ...
    'wh': 'напишите, пожалуйста, мне в Jabber, когда вам будет удобно, чтобы я подключилась для решения проблемы',
    'o3': 'для активации лицензии Office 365 введите mariia.afanaseva@t-systems.ru и пароль как от компьютера',
	'nb': 'ноутбук готов. можете получить его в ит-отделе. выданы временные права администратора. для активации лицензии Office 365 введите <> и пароль как от компьютера',
